...
const projects = [
  {
    ...
    // Optimized: Lower quality/res for performance, assumes browser scaling or responsive img
    image: "https://images.unsplash.com/photo-1551847677-dc82d764e1eb?q=60&w=1200&auto=format&fit=crop", 
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=60&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?q=60&w=1200&auto=format&fit=crop", 
  ...
  },
  {
    ...
    category: "Monitoring",
    image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=60&w=1200&auto=format&fit=crop", 
...
export const Gallery: React.FC = () => {
        ...
        gsap.fromTo(
            ...
            { translateX: 0 },
            {
                ...
                scrollTrigger: {
                    ...
                    scrub: 0.5, // Reduced scrub time for less lag perception on touch
                    pin: true,
  ...
  return (
    <section id="gallery" className="bg-neutral-900 text-white relative z-20 overflow-hidden">
      <div ref={triggerRef}>
        <div
          ref={sectionRef}
